    ...
    <>
      ...
      {showResult && selectedEvent && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100] animate-fadeIn backdrop-blur-md p-4">
          ...
          <div className="bg-[#0a0a0a] rounded-xl max-w-[96vw] sm:max-w-md md:max-w-lg w-full border border-st-red/30 shadow-[0_0_50px_rgba(255,0,0,0.2)] animate-scaleIn relative overflow-hidden flex flex-col">
            ...
            <div className="p-4 sm:p-6 md:p-8 text-center relative z-10">
              ...
              <div className="space-y-1 mb-4">
                <h2 className="text-st-red text-xs md:text-sm uppercase tracking-[0.2em] font-bold">Lucky Pick</h2>
                <h3 className="text-white text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-wider leading-tight" style={{ fontFamily: "'Orbitron', sans-serif" }}>
                  {selectedEvent.title}
                </h3>
              </div>
              ...
              <div className="bg-black/40 border border-white/5 rounded-xl p-4 sm:p-5 mb-2 relative max-h-[28vh] sm:max-h-[36vh] overflow-auto">
            ...
            {/* Footer Actions */}
            <div className="p-4 sm:p-5 bg-white/5 border-t border-white/5 flex flex-col sm:flex-row gap-3">
              <button
                onClick={handleViewDetails}
                className="w-full sm:flex-1 bg-st-red hover:bg-red-600 text-white font-bold uppercase tracking-widest text-xs py-3.5 px-6 rounded-lg transition-all duration-300 shadow-[0_0_20px_rgba(255,0,0,0.3)] hover:shadow-[0_0_30px_rgba(255,0,0,0.5)] transform active:scale-[0.98]"
              >
                View Event
              </button>
              <button
                onClick={() => setShowResult(false)}
                className="w-full sm:w-auto px-6 py-3.5 bg-transparent hover:bg-white/10 text-gray-400 hover:text-white font-bold uppercase tracking-widest text-xs rounded-lg border border-white/10 transition-all duration-300"
              >
                Close
              </button>
            </div>
