...
const LuckyEventModal = ({ event, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-[96vw] sm:max-w-md md:max-w-lg transform scale-100 transition-all duration-500 ease-out animate-in zoom-in-95">
                ...
                <div className="relative bg-[#1a1a1a] rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] max-h-[80vh] sm:max-h-[85vh] flex flex-col">
                    {/* Header */}
                    ...
                    {/* Body */}
                    <div className="p-4 sm:p-5 md:p-8 text-center space-y-4 md:space-y-6 overflow-y-auto custom-scrollbar flex-grow">
                        <div className="text-4xl sm:text-5xl md:text-7xl mb-3 md:mb-4 transform hover:scale-105 transition-transform duration-300 filter drop-shadow-[0_0_16px_rgba(255,255,255,0.25)]">
                            {event.icon}
                        </div>
                        <div className="max-w-full sm:max-w-md mx-auto px-2">
