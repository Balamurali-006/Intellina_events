            ...
            <div id="timeline-wrapper" className="relative">
                ...
                <div className="relative z-10 min-h-screen flex flex-col items-center">
                    ...
                    <div className={`w-full max-w-4xl px-2 sm:px-4 pb-40 relative transition-all duration-500 ${isAnimating ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
                        <div className={`absolute left-1/2 top-0 bottom-0 w-[3px] -translate-x-1/2 z-0 transition-colors duration-1000 ${activeDay === 'day1' ? 'bg-[#1a0505] border-l border-red-900/50 shadow-[0_0_10px_rgba(102,0,0,0.3)]' : 'bg-[#05051a] border-l border-blue-900/50 shadow-[0_0_10px_rgba(0,0,102,0.3)]'}`}>
