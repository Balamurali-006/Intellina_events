...
const TimelineEvent = ({ event, index, activeDay }) => {
    ...
    return (
        <div className="relative mb-16 sm:mb-24 px-4 sm:px-6 md:pl-0 md:grid md:grid-cols-2 md:gap-16 group perspective-2000">
            <div className="absolute left-1/2 top-8 -translate-x-1/2 w-8 h-8 sm:w-10 sm:h-10 z-10 flex items-center justify-center">
            ...
            <div className={`${isRight ? 'md:col-start-2 md:text-left' : 'md:col-start-1 md:text-right md:order-first'} relative text-center md:text-left mx-auto max-w-xl`}>
