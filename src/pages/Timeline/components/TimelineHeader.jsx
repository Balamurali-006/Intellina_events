...
const TimelineHeader = () => {
    return (
        <header className="sticky top-0 w-full p-4 flex justify-center items-center z-50 backdrop-blur-sm bg-black/40 border-b border-red-900/20 shadow-[0_4px_30px_rgba(0,0,0,0.5)] group">
